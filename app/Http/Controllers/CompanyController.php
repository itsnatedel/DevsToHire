<?php
    ...
    class CompanyController extends Controller
    {
        ...
        {
            if (Str::slug(Auth::user()->firstname . ' ' . Auth::user()->lastname) !== app('request')->route()->parameter('slug')) {
                
                if (!Controller::resourceExists('company', $id, $request->route()->parameter('slug'))) {
                    return redirect()->route('error-404')->with('message', 'No company found with these parameters.');
                }
            }
