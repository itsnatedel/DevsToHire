...
class Job extends Model
{
	...
	/**
	 * @method checkIfUserApplied
	 * Checks if an user already applied to a given job
	 * @param int $jobId
	 * @param int $userId
	 *
	 * @return bool
	 */
	public static function checkIfUserApplied(int $jobId, int $userId): bool
	{
		$candidate = DB::table('candidates as ca')
			->select('ca.id')
			->where([
				'ca.job_id' => $jobId,
				'ca.user_id' => $userId
	 ...
	 * Cancels the user's application for a job
	 *
	 * @param $jobId
	 * @param $freelancerId
	 *
	 * @return bool
	 */
	public static function cancelApplication($jobId, $freelancerId): bool
	{
		// Check if application exists
		$application = DB::table('candidates as ca')
			->select('ca.id')
			->where([
				'ca.job_id' => $jobId,
	...
	public static function getCompanyRating(int $id)
	{
		...
		return DB::table('ratings_companies as rc')
			->select(DB::raw('SUM(rc.note) / COUNT(rc.id) as rating'))
