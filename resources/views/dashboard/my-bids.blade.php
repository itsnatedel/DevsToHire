                                        ...
                                        <li>
                                            ...
                                            <div class="job-listing width-adjustment">
                                                ...
                                                <div class="job-listing-details">
                                                    ...
                                                    <div class="job-listing-description">
                                                        <h3 class="job-listing-title"><a href="#">WordPress Guru
                                                                Needed</a></h3>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="buttons-to-right always-visible">
                                                <a href="#small-dialog"
                                                   ...
                                                   title="Edit Bid" data-tippy-placement="top"><i
                                                        class="icon-feather-edit"></i></a>
                                                <a href="#" class="button red ripple-effect ico" title="Cancel Bid"
                                        ...
                                        <li>
                                            ...
                                            <div class="job-listing width-adjustment">
                                                ...
                                                <div class="job-listing-details">
                                                    ...
                                                    <!-- Details -->
                                                    <div class="job-listing-description">
                                                        <h3 class="job-listing-title"><a href="#">Build me a website in
                                                                Angular JS</a></h3>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <li>
                                            ...
                                            <div class="job-listing width-adjustment">
                                                ...
                                                <div class="job-listing-details">
                                                    ...
                                                    <!-- Details -->
                                                    <div class="job-listing-description">
                                                        <h3 class="job-listing-title"><a href="#">Android and iOS React
                                                                Appe</a></h3>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <li>
                                            ...
                                            <div class="job-listing width-adjustment">
                                                ...
                                                <div class="job-listing-details">
                                                    ...
                                                    <!-- Details -->
                                                    <div class="job-listing-description">
                                                        <h3 class="job-listing-title"><a href="#">Write Simple Python
                                                                Script</a></h3>
                                                    </div>
                                                </div>
                                            </div>
