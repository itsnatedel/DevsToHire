                                            ...
                                            <div class="job-listing">
                                                ...
                                                <div class="job-listing-details">
                                                    ...
                                                    <div class="job-listing-description">
                                                        <h3 class="job-listing-title"><a href="#">Barista and
                                                                Cashier</a></h3>
                                                        ...
                                                        <div class="job-listing-footer">
                                                            <ul>
                                                                ...
                                                                <li><i class="icon-material-outline-access-time"></i> 2
                                                                    days ago
                                                                </li>
                                                            </ul>
                                                        </div>
                                        ...
                                        <li>
                                            ...
                                            <div class="job-listing">
                                                ...
                                                <div class="job-listing-details">
                                                    ...
                                                    <!-- Details -->
                                                    <div class="job-listing-description">
                                                        <h3 class="job-listing-title"><a href="#">Administrative
                                                                Assistant</a></h3>

                                                        <!-- Job Listing Footer -->
                                                        <div class="job-listing-footer">
                                                            <ul>
                                                                <li><i class="icon-material-outline-business"></i> Mates
                                                                </li>
                                                                <li><i class="icon-material-outline-location-on"></i>
                                                                    San Francisco
                                                                </li>
                                        ...
                                        <li>
                                            ...
                                            <div class="job-listing">
                                                ...
                                                <div class="job-listing-details">
                                                    ...
                                                    <!-- Details -->
                                                    <div class="job-listing-description">
                                                        <h3 class="job-listing-title"><a href="#">Construction
                                                                Labourers</a></h3>
