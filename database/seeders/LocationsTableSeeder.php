...
class LocationsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $arrayCountries = array(
            ...
            "AX" => array('alpha2' => 'AX', "name" => "Åland Islands"),
            ...
            "AG" => array('alpha2' => 'AG', "name" => "Antigua and Barbuda"),
            "AR" => array('alpha2' => 'AR', "name" => "Argentina"),
            "AM" => array('alpha2' => 'AM', "name" => "Armenia"),
            "AW" => array('alpha2' => 'AW', "name" => "Aruba"),
            ...
            "BB" => array('alpha2' => 'BB', "name" => "Barbados"),
            ...
            "BM" => array('alpha2' => 'BM', "name" => "Bermuda"),
            "BT" => array('alpha2' => 'BT', "name" => "Bhutan"),
            "BO" => array('alpha2' => 'BO', "name" => "Bolivia"),
            "BQ" => array('alpha2' => 'BQ', "name" => "Bonaire, Sint Eustatius and Saba"),
            "BA" => array('alpha2' => 'BA', "name" => "Bosnia and Herzegovina"),
            "BW" => array('alpha2' => 'BW', "name" => "Botswana"),
            "BV" => array('alpha2' => 'BV', "name" => "Bouvet Island"),
            "BR" => array('alpha2' => 'BR', "name" => "Brazil"),
            "IO" => array('alpha2' => 'IO', "name" => "British Indian Ocean Territory"),
            "BN" => array('alpha2' => 'BN', "name" => "Brunei Darussalam"),
            ...
            "CX" => array('alpha2' => 'CX', "name" => "Christmas Island"),
            "CC" => array('alpha2' => 'CC', "name" => "Cocos (Keeling) Islands"),
            "CO" => array('alpha2' => 'CO', "name" => "Colombia"),
            "KM" => array('alpha2' => 'KM', "name" => "Comoros"),
            "CG" => array('alpha2' => 'CG', "name" => "Congo"),
            "CD" => array('alpha2' => 'CD', "name" => "The Democratic Republic of The Congo"),
            "CK" => array('alpha2' => 'CK', "name" => "Cook Islands"),
            ...
            "FK" => array('alpha2' => 'FK', "name" => "Falkland Islands (Malvinas)"),
            "FO" => array('alpha2' => 'FO', "name" => "Faroe Islands"),
            ...
            "TF" => array('alpha2' => 'TF', "name" => "French Southern Territories"),
            ...
            "HM" => array('alpha2' => 'HM', "name" => "Heard Island and Mcdonald Islands"),
            "VA" => array('alpha2' => 'VA', "name" => "Holy See (Vatican City State)"),
            ...
            "IM" => array('alpha2' => 'IM', "name" => "Isle of Man"),
            ...
            "LA" => array('alpha2' => 'LA', "name" => "Lao People's Democratic Republic"),
            ...
            "MH" => array('alpha2' => 'MH', "name" => "Marshall Islands"),
            ...
            "FM" => array('alpha2' => 'FM', "name" => "Micronesia"),
            ...
            "MP" => array('alpha2' => 'MP', "name" => "Northern Mariana Islands"),
            ...
            "RU" => array('alpha2' => 'RU', "name" => "Russian Federation"),
            "RW" => array('alpha2' => 'RW', "name" => "Rwanda"),
            "BL" => array('alpha2' => 'BL', "name" => "Saint Barthélemy"),
            "SH" => array('alpha2' => 'SH', "name" => "Saint Helena"),
            "KN" => array('alpha2' => 'KN', "name" => "Saint Kitts and Nevis"),
            "LC" => array('alpha2' => 'LC', "name" => "Saint Lucia"),
            "MF" => array('alpha2' => 'MF', "name" => "Saint Martin"),
            "PM" => array('alpha2' => 'PM', "name" => "Saint Pierre and Miquelon"),
            "VC" => array('alpha2' => 'VC', "name" => "Saint Vincent and The Grenadines"),
            ...
            "SJ" => array('alpha2' => 'SJ', "name" => "Svalbard and Jan Mayen"),
            ...
            "UM" => array('alpha2' => 'UM', "name" => "United States Minor Outlying Islands"),
            ...
            "VG" => array('alpha2' => 'VG', "name" => "Virgin Islands, British"),
            "VI" => array('alpha2' => 'VI', "name" => "Virgin Islands, U.S."),
            "WF" => array('alpha2' => 'WF', "name" => "Wallis and Futuna"),
