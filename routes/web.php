<?php
    ...
    */
    ...
    Route::group(['prefix' => 'tasks'], function ()
    {
        ...
        Route::get('/{taskId}/{taskSlug}/{fileUrl}', [TaskController::class, 'downloadBrief'])
            ->where('taskId', '[0-9]+')
            ->where('taskSlug', '[a-z-]+')
    ...
    Route::group(['prefix' => 'dashboard', 'middleware' => 'auth'], static function ()
    {
        ...
        Route::get('/download/cv/{freelancerId}/{filename}', [DashboardController::class, 'downloadCV'])
            ->where('freelancerId', '[0-9]+')
